                        ...
                        TextButton(onClick = {
                            coroutineScope.launch {
                                try {
                                    ...
                                    RetrofitClient.apiService.acceptFriendRequest(mapOf("request_id" to dialogData.optString("request_id"))
                                    )
                                } catch (e: Exception) {}
                    ...
                    dismissButton = {
                        TextButton(onClick = {
                            coroutineScope.launch {
                                try {
                                    val token = com.simats.myfitnessbuddy.data.local.SettingsManager.authToken ?: ""
                                    RetrofitClient.apiService.rejectFriendRequest(mapOf("request_id" to dialogData.optString("request_id"))
                                    )
                                } catch (e: Exception) {}
                                friendRequestDialog = null
                            }
